...
* **Header e Navegação:** Menu de navegação fixo com ícones de busca e carrinho de compras.
* **Hero Section:** Apresentação impactante com chamada para ação e imagem de alta qualidade de grãos de café.
* **Sobre Nós:** Seção detalhada com imagem e texto sobre a missão da cafeteria.
* **Nosso Menu:** Layout em grade (Grid/Flexbox) para exibição dos produtos (Café Coado), com preços e botões de **"Adicione ao Carrinho"** estilizados.
* **Nossos Clientes (Avaliações):** Seção de prova social com cards de depoimentos e sistema de avaliação por estrelas, demonstrando o uso de ícones e layouts de citação.
* **Nosso Endereço:** Integração visual de mapa (via imagem ou embed) com informações de localização e links sociais no rodapé.
...
1.  Clone o repositório:
    ...
    ```
2.  Navegue até a pasta clonada e abra o arquivo **`index.html`** em seu navegador.

---

### Autor

Desenvolvido por Luiz Gustavo Silva dos Anjos

LinkedIn: https://www.linkedin.com/in/luiz-gustavo-anjos-922563264/
